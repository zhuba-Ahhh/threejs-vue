...
`)+`
`+w);const b=M+d+a,N=M+w+o,L=xc(r,r.VERTEX_SHADER,b),R=xc(r,r.FRAGMENT_SHADER,N);r.attachShader(p,L),r.attachShader(p,R),t.index0AttributeName!==void 0?r.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(p,0,"position"),r.linkProgram(p);function W(ue){if(n.debug.checkShaderErrors){const ae=r.getProgramInfoLog(p).trim(),U=r.getShaderInfoLog(L).trim(),ee=r.getShaderInfoLog(R).trim();let X=!0,J=!0;if(r.getProgramParameter(p,r.LINK_STATUS)===!1)if(X=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,p,L,R);else{const G=Mc(r,L,"vertex"),te=Mc(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(p,r.VALIDATE_STATUS)+`
